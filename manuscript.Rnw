...
drugcost_dt <-  data.table(
    ...
    est = c(rep(2000, n_i -1), 1500, 
            rep(12000, n_i -1), 1000,
            rep(15000, n_i - 1), 1200
            ) 
)
@
