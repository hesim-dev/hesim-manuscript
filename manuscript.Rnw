...
psmfit_wei <- flexsurvreg_list(fit_pfs_wei, fit_os_wei)
@
...
<<psm_survmods>>=
survmods <- create_PsmCurves(psmfit_wei,
                             input_data = survmods_data,
                             n = n_samples,
                             bootstrap = FALSE, est_data = surv_est_data)
@
